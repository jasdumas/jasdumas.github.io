...
```{r, ggvis, fig.path='{{ site.url }}/data-viz-compare_files/figure-html/gvis.html'}
library(ggvis)
data(iris)
...
## rCharts
<http://rcharts.io/>
```{r, rCharts, fig.path='{{ site.url }}/post_data/data-viz-compare-'}
library(rCharts)
...
## plotly
<https://plot.ly/r/>
```{r, plotly, fig.path='{{ site.url }}/post_data/data-viz-compare-'}
library(plotly)
data(iris)
...
```{r, ggplotly, fig.path='{{ site.url }}/post_data/data-viz-compare-'}
p <- ggplot(iris) +
      geom_point(aes(x=Sepal.Length, y=Petal.Length, color = Species)) +
